...
public class Company {
    ...
    private MyCalendar date = new MyCalendar();//TODO fix the import calendar. and the extends MyCalendar
//    private String[] schedules = new String[maxSize];
//    private int counterSchedules = 0;
//    private Stack<ArrayList<Employee>> stackEmployees= new Stack<ArrayList<Employee>>();
    /*
    ...
    private int returnValidShowInfo(){
        ...
        while(error){
            ...
            if(choice < 1 || choice > 2){
                System.out.print("Invalid entry! Expecting values from 1 or 2! Try again! Choice:");
                error = true;
            }
            else break;
        }
    ...
    public void addEmployee() { //////////////// fix cloned code
        read.nextLine();
